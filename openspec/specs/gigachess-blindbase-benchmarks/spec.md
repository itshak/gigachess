# gigachess-blindbase-benchmarks Specification
...
- **THEN** it reports throughput (ops/sec and games/sec) and peak heap for all 4 workloads, comparing GigaChess against `chessops` and `chess.js` baselines
