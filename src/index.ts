// src/index.ts — GigaChess root entry (MIT): Native Rust-Mirrored API
// Exports native Board, Undo, bitboards, Zobrist, packed moves, and rules.
// Note: The chess.js-compatible Chess class is exported via "gigachess/chessjs".
...
export * from "./san.js";
export * from "./pgn.js";
export { isCheck960, isCheckmate960, perft960 } from "./chess960.js";
